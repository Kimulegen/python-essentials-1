...
☑ Working with the `print()` function<br>
☑ The `print()` function and its arguments<br>
...
#### 2.4 Variables
☑ Variables<br>
☑ Variables - a simple converter<br>
...
☑ Variables - Questions and answers<br>
☑ Comparison operators and conditional execution<br>
☑ Essentials of the if-else statement<br>
☑ Essentials of the if-elif-else statement

#### 3.2 Loops in Python
☑ Guess the secret number<br>
☑ Essentials of the loop - counting mississippily<br>
☑ The break statement - Stuck in a loop<br>
☑ The continue statement - The Ugly Vowel Eater<br>
☑ The continue statement - The Pretty Vowel Eater<br>
☑ Essentials of the while loop<br>
☑ Collat's hypothesis

#### 3.3 Logic and bit operations
#### 3.4 Lists
☑ The basics of lists<br>
...
☑ A leap year: writing your own functions<br>
☑ How many days: writing and using your own functions<br>
☑ Day of the year: writing and using your own functions<br>
☑ Prime number - how to find them<br>
